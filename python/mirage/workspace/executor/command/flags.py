...
def option_error(cmd_name: str,
    ...
    # The first refused value on the line, whichever check refused it:
    # GNU stops there, so `numfmt --from=bad1 --to=bad2` names bad1. The
    # kinds tape holds the three tags in scan order, and each list is in
    # scan order too.
