...
async function main(): Promise<void> {
  ...
  let r = await ws.execute('ls /github/python/mirage/vfs')
  console.log(r.stdoutText)
  console.log('--- stat /github/python/mirage/vfs/base.py ---')
  r = await ws.execute('stat /github/python/mirage/vfs/base.py')
  ...
  r = await ws.execute('cat /github/python/mirage/vfs/base.py | head -n 5')
